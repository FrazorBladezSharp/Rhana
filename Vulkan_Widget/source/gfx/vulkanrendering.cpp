...
VulkanRendering::VulkanRendering(QVulkanWindow *w, bool msaa)
    : m_window(w)
{
    qInfo()
            << "\nVulkanRendering Created\n";
    if (msaa) {
...
void VulkanRendering::initResources()
{
    ...
    qInfo()
            << "\nShaders\n";
    VkShaderModule vertShaderModule = createShader("./color_vert.spv");
    VkShaderModule fragShaderModule = createShader("./color_frag.spv");
